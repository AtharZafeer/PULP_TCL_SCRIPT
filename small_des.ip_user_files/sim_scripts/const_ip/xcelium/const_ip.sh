...
#                script (type 'const_ip.sh -help' for more information).
#
...
design_libs_elab="-libname xlconstant_v1_1_8 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xlconstant_v1_1_8 xil_defaultlib)
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.const_ip xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.const_ip -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log const_ip_sc.so .tmp_log xcelium_lib waves.shm c.obj)

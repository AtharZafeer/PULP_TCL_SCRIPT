...
#
# Script generated by Vivado on Mon Jan 22 16:39:28 UTC 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : const_ip.sh
...
#
# Usage        : const_ip.sh
#                const_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                const_ip.sh [-reset_run]
#                const_ip.sh [-reset_log]
#                const_ip.sh [-help]
#
...
# script info
echo -e "const_ip.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./const_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xlconstant_v1_1_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot const_ip xil_defaultlib.const_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim const_ip -key {Behavioral:sim_1:Functional:const_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/const_ip.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/cad/xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb const_ip.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./const_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: const_ip.sh [-help]\n\
Usage: const_ip.sh [-step]\n\
Usage: const_ip.sh [-lib_map_path]\n\
Usage: const_ip.sh [-reset_run]\n\
Usage: const_ip.sh [-reset_log]\n\
Usage: const_ip.sh [-keep_index]\n\
Usage: const_ip.sh [-noclean_files]\n\n\

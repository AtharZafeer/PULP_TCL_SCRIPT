...
design_libs=(xlconstant_v1_1_8 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.const_ip xil_defaultlib.glbl -o const_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./const_ip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key const_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc const_ip_simv.daidir vcs_lib c.obj)
